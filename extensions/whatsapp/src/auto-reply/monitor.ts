...
export async function monitorWebChannel(
  ...
  const transportTimeoutMs = tuning.transportTimeoutMs ?? messageTimeoutMs;
  ...
  try {
    while (true) {
      ...
      setActiveWebListener(account.accountId, connection.listener as unknown as ActiveWebListener);
