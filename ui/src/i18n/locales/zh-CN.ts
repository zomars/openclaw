...
export const zh_CN: TranslationMap = {
  ...
  sessionsView: {
    ...
    overflowRetry: "溢出重试",
    timeoutRetry: "超时重试",
    tokenRange: "{before} → {after} 个 token",
  ...
  cron: {
    ...
    form: {
      ...
      scriptHelp: "直接运行Shell命令。无LLM，无Token消耗。",
      scriptCommand: "命令",
      scriptCommandPlaceholder: "如 node、bash、python3",
      scriptArgs: "参数",
      scriptArgsPlaceholder: "空格分隔，如 script.mjs --flag",
      scriptCwd: "工作目录",
      scriptCwdPlaceholder: "可选，如 /Users/me/.openclaw",
      timeoutSeconds: "超时（秒）",
    ...
    errors: {
      ...
      scriptCommandRequired: "脚本命令为必填项。",
