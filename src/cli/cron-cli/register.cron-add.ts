...
export function registerCronAddCommand(cron: Command) {
  addGatewayClientOptions(
    cron
      ...
      .option("--script <command>", "Script command to run (no LLM needed)")
        ...
        async (
          ...
          try {
            ...
            if (
              ...
              throw new Error(
                "Isolated/current/custom-session jobs require --message (agentTurn), --command, or --script.",
              );
            }
            if (
              ...
              : isIsolatedLikeSessionTarget &&
                ...
                ? hasAnnounce
                  ...
                  : hasNoDeliver
                    ? "none"
                    : "announce"
                : sessionTarget === "isolated" && payload.kind === "script"
                  ? hasAnnounce
                    ? "announce"
                    : "none"
                  : undefined;
